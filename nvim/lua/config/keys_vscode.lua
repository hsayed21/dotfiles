...
Map("n", "<leader>gtfb", function()  VSCodeNotify("gitlens.toggleFileBlame") end, { desc = "Toggle Git Blame" })
Map("n", "<leader>gtlb", function() VSCodeNotify("gitlens.toggleLineBlame") end, { desc = "Toggle line blame" })
Map("n", "<leader>gtfc", function() VSCodeNotify("gitlens.toggleFileChanges") end, { desc = "Toggle line blame" })
Map("n", "<leader>gvh", function() VSCodeNotify("githd.viewHistory") end, { desc = "Git History" })
Map("n", "<leader>gvfh", function() VSCodeNotify("githd.viewFileHistory") end, { desc = "Git History File" })
Map("n", "<leader>gch", function()  VSCodeNotify("git.checkout") end, { desc = "Checkout to" })
Map("n", "<leader>gss", function() VSCodeNotify("gitlens.stashSave") end, { desc = "Stash All Changes" })
Map("n", "<leader>gpl,", function()  VSCodeNotify("git.pull") end, { desc = "Pull" })
Map("n", "<leader>gps,", function()  VSCodeNotify("git.push") end, { desc = "Push" })
