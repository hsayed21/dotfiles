...
Map("n", "<leader>sw", function() VSCodeNotify("workbench.action.showAllSymbols") end, { desc = "Show all workspace symbols" })
...
Map("n", "<leader>db", function() VSCodeNotify("workbench.action.problems.focus") end, { desc = "Focus on problems 'diagnostics'" })
Map("n", "<leader>td", function() VSCodeNotify("workbench.actions.view.problems") end, { desc = "Toggle problems 'diagnostics'" })
...
Map("n", "<leader>,K", function() VSCodeNotify("workbench.action.reopenClosedEditor") end, { desc = "Reopen closed editor" })
...
Map("n", "<leader>pn", function() VSCodeNotify("projectManager.listProjectsNewWindow") end, { desc = "List projects in new window" })
...
Map('n', '<leader>tw', ':%s/\\(\\S\\)\\([ \\t]\\{3,\\}\\)\\(\\/\\/\\|--\\|#\\|;\\|\\*\\*\\?\\|\\<REM\\>\\)/\\1  \\3/g<CR>', { desc = "Trim whitespace before comments" })

-- ##### window management
-- Split window
Map("n", "<leader>vs", function() VSCodeNotify("workbench.action.splitEditorRight") end, { desc = "Split window vertically" })  -- split window vertically
Map("n", "<leader>hs", function() VSCodeNotify("workbench.action.splitEditorDown") end, { desc = "Split window horizontally" }) -- split window horizontally

-- Focusing around windows
Map({ "n", "t" }, "<A-h>", function() VSCodeNotify("workbench.action.focusLeftGroup") end, { desc = "Move to window left" })  -- move to window left
Map({ "n", "t" }, "<A-j>", function() VSCodeNotify("workbench.action.focusBelowGroup") end, { desc = "Move to window down" })  -- move to window down
Map({ "n", "t" }, "<A-k>", function() VSCodeNotify("workbench.action.focusAboveGroup") end, { desc = "Move to window up" })  -- move to window up
Map({ "n", "t" }, "<A-l>", function() VSCodeNotify("workbench.action.focusRightGroup") end, { desc = "Move to window right" }) -- move to window right
...
Map("n", "<A-S-j>", function() VSCodeNotify("workbench.action.decreaseViewHeight") end, { desc = "Decrease window height" })  -- decrease window height
Map("n", "<A-S-k>", function() VSCodeNotify("workbench.action.increaseViewHeight") end, { desc = "Increase window height" })  -- increase window height

-- Moving around splits
Map("n", "<C-S-h>", function() VSCodeNotify("workbench.action.moveActiveEditorGroupLeft") end, { desc = "Move split to the left" })  -- move split to the left
Map("n", "<C-S-j>", function() VSCodeNotify("workbench.action.moveActiveEditorGroupDown") end, { desc = "Move split down" })  -- move split down
Map("n", "<C-S-k>", function() VSCodeNotify("workbench.action.moveActiveEditorGroupUp") end, { desc = "Move split up" }) -- move split up
Map("n", "<C-S-l>", function() VSCodeNotify("workbench.action.moveActiveEditorGroupRight") end, { desc = "Move split to the right" })  -- move split to the right


-- telescope
-- Map("n", "<C-p>", function() VSCodeNotify("workbench.action.quickOpen") end)
Map("n", "<leader>sb", function() VSCodeNotify("workbench.action.showAllEditorsByMostRecentlyUsed") end, { desc = "List all buffers" })
